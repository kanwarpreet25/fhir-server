...
public class Authorization implements IConsentService {
  ...
  private static boolean requesterOwnsDraftResource(
    DomainResource theResource,
  ...
  private static Coding hasMatchingUsernameTag(
    DomainResource theResource,
    String requestingUser
  ) {
    return theResource
      .getMeta()
      .getTag("https://simplifier.net/dot.base/requesting-username", requestingUser);
  }
}
