package ca.uhn.fhir.jpa.starter.moveBase.searchBuilder;
...
public class Queries {
    ...
    protected static String notMatchAll(String findFieldName, String searchFieldName, String targetResourceType, boolean haveTargetTypesDefinedByParam){
    ...
    private static String haveTargetTypesDefinedByParam(String findFieldName, String searchFieldName){
        return "SELECT r." +
        findFieldName +
        ",r.myTargetResourceUrl  FROM ResourceLink r WHERE r.mySourcePath = :src_path AND r." +
        searchFieldName +
